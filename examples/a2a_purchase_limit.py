...
contract = GovernedContract(
    contract_id="gc-purchase-001", issuer=org, subject=buyer,
    authority=[AuthorityGrant(grant_id="grant-purchase-001", granted_by=org.party_id, granted_to=buyer.party_id, actions=["purchase"], resources=["catalog:item-42"], purposes=["restock"])],
...
intent = ActionIntent(intent_id="a2a-task-purchase-001", actor=buyer, action="purchase", resource="catalog:item-42", purpose="restock", requested_at=now, attributes={"amount": "1200.00", "currency": "EUR"})
